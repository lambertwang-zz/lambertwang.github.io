...
// Utilities
var css_1 = __webpack_require__(58);
// Local
...
Object.defineProperty(exports, "__esModule", { value: true });
// Local
var actionNames_1 = __webpack_require__(25);
function toggleTheme() {
    return {
        type: actionNames_1.TOGGLE_THEME,
    };
}
...
var rootStore_1 = __webpack_require__(249);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(97), __webpack_require__(223)(module)))
...
var Header_1 = __webpack_require__(236);
var fontLoader_1 = __webpack_require__(241);
var pullout_1 = __webpack_require__(242);
// Reducers
// import RootReducer from '../reducers/rootReducer';
// Actions
var togglePullout_1 = __webpack_require__(247);
var toggleTheme_1 = __webpack_require__(103);
// Utilities
var css_1 = __webpack_require__(58);
var responsive_1 = __webpack_require__(248);
...
var RootPresentation = /** @class */ (function (_super) {
    ...
    RootPresentation.prototype.render = function () {
        var _a = this.props, onTogglePullout = _a.onTogglePullout, onToggleTheme = _a.onToggleTheme, theme = _a.theme, isPulloutVisible = _a.isPulloutVisible;
        ...
        return (React.createElement("div", { className: css_1.default('root', (_b = {},
                _b[constants_1.THEME[theme]] = true,
                _b)) },
...
function mapDispatchToProps(dispatch, ownProps) {
    return {
        onTogglePullout: function () {
            dispatch(togglePullout_1.default('Did this change?'));
        },
        onToggleTheme: function () {
            dispatch(toggleTheme_1.default());
        },
    };
}
...
var React = __webpack_require__(13);
// Components
var MenuItem_1 = __webpack_require__(102);
// Local
...
// module
exports.push([module.i, "body {\n  user-select: none;\n  cursor: default;\n  margin: 0;\n  font-family: \"Droid Sans\"; }\n\n.menuItem {\n  display: inline-block;\n  cursor: pointer;\n  margin: 0;\n  transition: all 0.3s cubic-bezier(0.16, 0.65, 0.45, 0.84);\n  text-align: center;\n  height: 100%;\n  line-height: normal; }\n  .menuItem i {\n    width: 1em; }\n  .menuItem i, .menuItem span {\n    padding-left: .4em;\n    display: inline-block;\n    font-size: 1em;\n    transition: all 0.3s cubic-bezier(0.16, 0.65, 0.45, 0.84);\n    line-height: 2em; }\n\n.withLabel i {\n  vertical-align: top; }\n", ""]);
...
// module
exports.push([module.i, "body {\n  user-select: none;\n  cursor: default;\n  margin: 0;\n  font-family: \"Droid Sans\"; }\n\n.light .header {\n  background-color: #eee8d5;\n  color: #586e75; }\n\n.light .header .header-left .menuItem:hover {\n  background-color: #fdf6e3;\n  color: #657b83; }\n\n.header {\n  background-color: #073642;\n  color: #93a1a1;\n  line-height: 2em;\n  height: 2em;\n  font-size: 32px;\n  text-align: center;\n  align-items: center; }\n  .header .header-left {\n    position: absolute; }\n    .header .header-left .menuItem:hover {\n      background-color: #002b36; }\n      .header .header-left .menuItem:hover i {\n        color: #839496; }\n  .header .header-title {\n    position: absolute;\n    transform: translate(-50%, 0%); }\n", ""]);
...
var react_redux_1 = __webpack_require__(55);
// Actions
var closePullout_1 = __webpack_require__(243);
var toggleTheme_1 = __webpack_require__(103);
// Local
var Pullout_1 = __webpack_require__(244);
function mapStateToProps(state, ownProps) {
    return {
...
// Local
var rootReducer_1 = __webpack_require__(250);
...
var actionNames_1 = __webpack_require__(25);
// Components
var pullout_1 = __webpack_require__(251);
// Utilities
var constants_1 = __webpack_require__(104);
exports.reducer = redux_1.combineReducers({
    pullout: pullout_1.reducer,
    root: function (state, action) {
        if (state === void 0) { state = { theme: constants_1.THEME.dark }; }
        var type = action.type;
        switch (type) {
            case actionNames_1.TOGGLE_THEME:
...
exports.reducer = redux_1.combineReducers({
    title: function (state, action) {
        if (state === void 0) { state = 'Default title'; }
        var type = action.type, title = action.title;
        switch (type) {
